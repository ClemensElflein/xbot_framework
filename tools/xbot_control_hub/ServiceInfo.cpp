...
ServiceInfo::ServiceInfo(const uint32_t node_id[4], const uint16_t service_id, const uint32_t ip, const uint16_t port,
                         std::string type,
                         const uint32_t version, std::vector<ServiceInputInfo> inputs)
